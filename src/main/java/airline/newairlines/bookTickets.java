...
public class bookTickets extends javax.swing.JInternalFrame {
     ...
     * @param i
     */
    public bookTickets(int i,int uid) {
        initComponents();
        idGenerate();
        uuid = uid;
        String sg = "select * from user where id  = '"+uid+"' ";
        try
        {
         ResultSet rs = con.s.executeQuery(sg);
         if(rs.next())
         {
             i = Integer.parseInt(rs.getString(cid));
         }
        }
        catch(Exception e)
        {
    ...
    private void idGenerate() {
        ...
        ResultSet rs1 = con.s.executeQuery("select MAX(ticketnum) from ticket");
        rs1.next();
            rs1.getString("MAX(ticketnum)");
            if(rs1.getString("MAX(ticketnum)") == null)
            {
                tnum = 1;
            }
            else
            {
                int lid = Integer.parseInt(rs1.getString("MAX(ticketnum)"));
                lid++;
              tnum = lid;
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(passp, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(custID))
                        .addGap(46, 46, 46)))
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Source", "Destination", "Total", "Available", "Type", "Price"
            }
        ));
    ...
    private void bookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookActionPerformed
        ...
        try{
        String str = "insert into ticket (ticket,fid,cid,clas,price,seat,td,ticketnum) values('"+ticket+"', '"+fid+"', '"+cid+"', '"+clas+"', '"+price+"', '"+seat+"', '"+td+"','"+tnum+"')";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            String str = "select * from customer where mid = '"+cid+"'";
            ResultSet rs = con.s.executeQuery(str);
    ...
    private void showCustomer(int i) {
        try {
             ...
             String sg = "select * from user where id  = '"+uuid+"' ";
        try
        {
         ResultSet rs = con.s.executeQuery(sg);
         if(rs.next())
        ...
        catch(Exception e)
        {
            ...
            String str = "select * from customer where mid = '"+i+"'";
            ResultSet rs = con.s.executeQuery(str);
