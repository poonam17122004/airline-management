...
public class customer extends javax.swing.JFrame {
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        String Ccid  = String.format("%03d", gh);
...
//            String str = "INSERT INTO customer values( '"+mid+"','"+firstname+"', '"+lastname+"', '"+adrs+"', '"+pass+"', '"+dob+"', '"+Gender+"', '"+contact+"',?)";
           con = DriverManager.getConnection("jdbc:mysql://localhost:3306/airlines","root1","");
            pst = con.prepareStatement("INSERT INTO customer (mid,firstname,lastname,address,passport,dob,gender,contact,id) values( '"+mid+"','"+firstname+"', '"+lastname+"', '"+adrs+"', '"+pass+"', '"+dob+"', '"+Gender+"', '"+contact+"' , '"+Ccid+"')");
            //pst.setBytes(1, userimage);
            pst.executeUpdate();
            
            try {
                String sr = "update user set cid = '"+mid+"' where mid='"+m+"'";
                System.out.println("  " + mid + "  " + m);
                System.out.println("SD " + m);
