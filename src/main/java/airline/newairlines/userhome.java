...
public class userhome extends javax.swing.JFrame {
    ...
    public userhome(String usr) {
        ...
        ResultSet rs = con.s.executeQuery(str);
            ...
            if(rs.next()) {
                String sf  = rs.getString("cid");
                if(sf!=null)
                cid = Integer.parseInt(rs.getString("cid"));
                uid = Integer.parseInt(rs.getString("id"));
                String ame = rs.getString("firstname") +" " + rs.getString("lastname"); 
...
//      pack();
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Passenger Registration");
...
//        jDesktopPane1.add(cus);
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        bookTickets T = new bookTickets(cid,uid);
        jDesktopPane1.add(T);
        T.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new userhome(args[0]).setVisible(true);
            }
        });
    }
